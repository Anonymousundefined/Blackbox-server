...
Blackbox Server is an ED Tech (Education Technology) web application developed using the MERN stack.
...
* User Authentication: Blackbox Server provides secure user registration and authentication using JWT (JSON Web Tokens). Users can sign up, log in, and manage their 
  profiles with ease.
  
* Courses and Lessons: Instructors can create and edit created courses. Students can enroll in courses, access course materials, and track their progress.
* Progress Tracking: Blackbox Server allows students to track their progress in enrolled courses. They can view completed lessons, scores on quizzes and 
  assignments, and overall course progress.
  
* Payment Integration: Blackbox Server integrates with Razorpay for payment processing. Users can make secure payments for course enrollment and other services 
...
1. Clone the repository to your local machine.
    ```sh
    git clone https://github.com/Anonymousundefined/Blackbox-server.git
    ```
